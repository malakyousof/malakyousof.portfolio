# ✦ Malak Yousof Ahmed — Portfolio

> *Turning data into clarity, one dataset at a time.*

&nbsp;

**🌸 [Live Site](https://malakyousof.github.io/malakyousof.portfolio/)**

&nbsp;

## what's inside

a personal portfolio for a data analytics student from cairo —
built with plain html/css/js and a supabase backend so projects
can be added, edited, and updated without touching the code.
